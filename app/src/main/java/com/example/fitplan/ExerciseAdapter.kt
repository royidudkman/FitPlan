...
import com.example.fitplan.databinding.ExerciseLayoutBinding

class ExerciseAdapter(private val exercises: List<Exercise>, private val callback: ExerciseListener) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ExerciseViewHolder {
        ...
        val binding = ExerciseLayoutBinding.inflate(inflater, parent, false)
