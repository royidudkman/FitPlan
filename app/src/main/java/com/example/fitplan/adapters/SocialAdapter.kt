...
import com.example.fitplan.UI.fragments.SocialViewModel
import com.example.fitplan.databinding.MyExerciseLayoutBinding
import com.example.fitplan.model.Plan

class SocialAdapter(private var plans: List<Plan>, private val callback: ExerciseListener, private val viewModel: SocialViewModel) :
    RecyclerView.Adapter<SocialAdapter.PlanViewHolder>() {
    ...
    fun deletePlanAt(position: Int) {
        ...
        viewModel.deleteSocialPlan(deletedPlan.id)
    }
}
